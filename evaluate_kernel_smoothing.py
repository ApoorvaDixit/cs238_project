...
print('Learnt policy: %.2f' % (compute_mean_discounted_reward(basis, learnt_policy, False)))
print('Random policy: %.2f' % (compute_mean_discounted_reward(basis, random_policy, True)))
